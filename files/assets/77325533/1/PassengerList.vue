...
<li v-for="(character,index) in characters" :key="character.eno" >
  ...
  <div class="imo">
    ...
    <nuxt-link class="profile-link1" :to="`/view/${character.eno}`">
<character-icon :src="character.mainicon"/></nuxt-link>

<nuxt-link class="profile-link" :to="`/view/${character.eno}`"><span class="eno" >No.{{ character.eno|zeroPad }}</span></nuxt-link>
<div class="profile">
<div class="info">

<div class="inu">
<nuxt-link class="profile-link" :to="`/view/${character.eno}`"><span class="name">{{ character.name }}</span></nuxt-link>
<br>
<nuxt-link class="profile-link" :to="`/view/${character.eno}`"><span class="hp">Ability:</span></nuxt-link>
<nuxt-link class="profile-link" :to="`/view/${character.eno}`"><span class="abi">{{ character.ability }}</span></nuxt-link></div></div>
</div>
...
<div class="summary" v-show="hoverFlag && index === hoverIndex " v-if="character.summary" v-on:mouseover="mouseOverAction(index)" v-on:mouseleave="mouseLeaveAction(index)" ontouchstart=””>
    <img v-if="character.doticon" class="dote" :src="character.doticon"><img v-else :src="character.noimage" class="dote" >
